...
## 4. 4 regions did not run before we reached the centralus. You should update the documentation to explicitly direct there. The list provided is inaccurate.
